-- Drop UUID extension dependency and convert all ID columns to BIGSERIAL
...
ALTER TABLE admin_boundaries ADD COLUMN id BIGSERIAL PRIMARY KEY;
ALTER TABLE admin_boundaries DROP COLUMN IF EXISTS parent_id;
ALTER TABLE admin_boundaries ADD COLUMN parent_id BIGINT REFERENCES admin_boundaries(id);
...
ALTER TABLE transport_stations ADD COLUMN id BIGSERIAL PRIMARY KEY;
ALTER TABLE transport_stations DROP COLUMN IF EXISTS line_ids;
ALTER TABLE transport_stations ADD COLUMN line_ids BIGINT[] DEFAULT '{}';
...
ALTER TABLE transport_lines ADD COLUMN id BIGSERIAL PRIMARY KEY;
ALTER TABLE transport_lines DROP COLUMN IF EXISTS station_ids;
ALTER TABLE transport_lines ADD COLUMN station_ids BIGINT[] DEFAULT '{}';
...
ALTER TABLE poi_categories ADD COLUMN id BIGSERIAL PRIMARY KEY;
